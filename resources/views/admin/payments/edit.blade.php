...
@section('title','Halaman Edit Pembayaran')
                                    ...
                                    <div class="col-12">
                                        <select name="booking_id" id="booking_id" class="form-control" required>
                                            ...
                                            @foreach($bookings as $booking)
                                                <option value="{{ $booking->id }}" {{ $booking->id == $data->booking_id ? 'selected' : null }} >{{ $booking->id }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <select name="payment_method" class="form-control" required>
                                            ...
                                            @if ($data->payment_method == "Gopay")
                                                ...
                                                <option value="LinkAja">LinkAja</option>
                                            @endif
                                            @if ($data->payment_method == "LinkAja")
                                                <option value="Transfer">Transfer</option>
                                                <option value="Dana">Dana</option>
                                                <option value="OVO">OVO</option>
                                                <option value="Gopay">Gopay</option>
                                                <option value="LinkAja" selected>LinkAja</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <input type="date" class="form-control" name="payment_date" id="payment_date" value="{{ old('payment_date', $data->payment_date) }}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <select name="status" class="form-control" required>
                                            ...
                                            @if ($data->status == "pending")    
                                                <option value="pending" selected>Belum Dibayar</option>
                                                <option value="paid">Sudah Dibayar</option>
                                                <option value="canceled">Cancel</option>
                                            @endif
                                            @if ($data->status == 'paid')
                                                <option value="pending">Belum Dibayar</option>
                                                <option value="paid" selected>Sudah Dibayar</option>
                                                <option value="canceled">Cancel</option>
                                            @endif
